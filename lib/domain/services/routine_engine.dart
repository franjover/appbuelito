...
class RoutineEngine {
  ...
  void _buildGreenDay(
    ...
    blocks.add(_block(0, AppConstants.blockNames[0], AppConstants.blockTimes[0], 15));
    ...
    blocks.add(_block(1, AppConstants.blockNames[1], AppConstants.blockTimes[1], 15));
    ...
    blocks.add(_block(2, AppConstants.blockNames[2], AppConstants.blockTimes[2], 10));
    ...
    blocks.add(_block(3, AppConstants.blockNames[3], AppConstants.blockTimes[3], 15));
    ...
    blocks.add(_block(4, AppConstants.blockNames[4], AppConstants.blockTimes[4], 15));
  ...
  void _buildYellowDay(
    ...
    blocks.add(_block(1, AppConstants.blockNames[1], AppConstants.blockTimes[1], 10));
    ...
    blocks.add(_block(3, AppConstants.blockNames[3], AppConstants.blockTimes[3], 10));
  ...
  void _buildRedDay(
    ...
    blocks.add(_block(0, AppConstants.blockNames[0], AppConstants.blockTimes[0], 20));
    ...
    blocks.add(_block(2, AppConstants.blockNames[2], AppConstants.blockTimes[2], 5));
